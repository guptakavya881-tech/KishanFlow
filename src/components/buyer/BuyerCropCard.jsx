...
export default function BuyerCropCard({ crop, onSelect }) {
  const {
    id,
    lotId,
    cropName,
  ...
  return (
    <div className="buyer-crop-card">
      ...
      <div style={{
        ...
        <button
          type="button"
          onClick={() => onSelect ? onSelect(crop) : null}
          style={{
            display: 'inline-flex',
            alignItems: 'center',
            gap: '6px',
